...
const ContactUs = () => {
  ...
  const saveContactUsData=async()=>
    {
       const res=await ToursandTravelsServices.saveContactUsData(formData);
       console.log(res.status)
       if(res.status==201)
        {
          console.log("Your response was saved our team will conatct you shortly")
        }
        else{
          console.log("an error please try again later")
        }
    }
