    ...
    <>
        ...
        <div className='absolute flex flex-col justify-center items-center top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20' >
            ...
            <div className='flex justify-center mt-6 items-center mt-16'>
                ...
                <button className='ml-4 px-16 py-2 bg-teal-500 bg-opacity-40 border border-teal-300 rounded shadow-xl hover:bg-opacity-80 transition-all duration-500 text-white'>Let's Go!</button>
            </div>
        </div>
    </>
  )
